    ...
    def __init__(self, config, mpasClimatologyTask,
        ...
        fields = \
            [{'prefix': 'temperature',
             ...
             {'prefix': 'csifw',
              'mpas': 'timeMonthly_avg_freshwaterTracers_seaIceFreshWaterConcentration',
              'units': r'',
              'titleName': 'SIFW Concentration',
              '3D': True,
              'obsFilePrefix': 'csifw',
              'obsFieldName': 'csifw',
              'obsBotFieldName': 'botCsifw'},
             {'prefix': 'vvisc',
             ...
             {'prefix': 'blu',
              'mpas': 'timeMonthly_avg_landIceFrictionVelocity',
              'units': r'm s$^{-1}$',
              'titleName': 'Friction velocity',
              '3D': False,
              'obsFilePrefix': 'blu',
              'obsFieldName': 'blu',
              'obsBotFieldName': 'botBlu'},
             {'prefix': 'blt',
              'mpas': 'timeMonthly_avg_landIceBoundaryLayerTracers_landIceBoundaryLayerTemperature',
              'units': r'$\degree$C',
              'titleName': 'BL Temperature',
              '3D': False,
              'obsFilePrefix': 'blt',
              'obsFieldName': 'blt',
              'obsBotFieldName': 'botBlt'},
             {'prefix': 'bls',
              'mpas': 'timeMonthly_avg_landIceBoundaryLayerTracers_landIceBoundaryLayerSalinity',
              'units': r'PSU',
              'titleName': 'BL Salinity',
              '3D': False,
              'obsFilePrefix': 'bls',
              'obsFieldName': 'bls',
              'obsBotFieldName': 'botBls'}]
