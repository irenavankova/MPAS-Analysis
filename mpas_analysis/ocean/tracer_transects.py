...
class TracerTransects(AnalysisTask):
    """
    ...
    def __init__(self, config, mpasClimatologyTask, controlConfig=None):
        ...
        super(TracerTransects, self).__init__(
            config=config, taskName='tracerTransects',
            componentName='ocean',
            tags=tags)
        ...
        for field in fields:
            ...
            for lon in longitudes:
                ...
                for season in seasons:
                    outFileLabel = 'Tracer_{}_'.format(fieldPrefix)
                    if plotObs:
                    ...
                    subtask.set_plot_info(
                        ...
                        imageCaption='{} {}'.format(fieldNameInTytle,
                                                    season),
                        galleryGroup='Tracer Transects',
                        groupSubtitle=None,
                        groupLink='tracer_transects',
                        galleryName=field['titleName'],
                        configSectionName='tracer{}Transects'.format(
                            fieldPrefixUpper),
